...
- checkpoint: `core/c17_ladder_1200_e4.pt`
...
```text
An airport is used for airplanes to take off and land. An airport is used for traveling things like a person or an anima
```
...
```text
An airplane flies through air. An airplane can carry people or cargo. An airplane takes the top part of a carperate and
```
...
```text
An airplane uses wings and engines to move through air. The engines push the airplane through an airplane the inside is
```

...
- checkpoint: `core/c17_contrast_review_repair_v2_e1.pt`
...
- source: ``
- score: `1.000`
- required_hits: `[['plant'], ['trunk'], ['branches']]`
- required_misses: `[]`
- forbidden_hits: `[]`
...
```text
A tree is a plant. A tree has a trunk. A tree has a branches.
```
...
```text
An airport is used for airplanes to take off and land. An airport is used for traveling through a stage.
```

### airplane_function_full - FAIL
...
```text
An airplane flies through air. An airplane can carry people or cargo. An airplane takes a person who is a part of airpla
```

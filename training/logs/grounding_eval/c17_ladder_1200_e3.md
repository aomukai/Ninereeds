...
- checkpoint: `core/c17_ladder_1200_e3.pt`
...
```text
An airport is used for airplanes to take off and land. An airport is used for traveling things like a part of a tarpust
```
...
```text
An airplane flies through air. An airplane can carry people or cargo. An airplane takes off cargo.
```
...
```text
An airplane uses wings and engines to move through air. The engines push the airplane to the number of airplanes to the
```

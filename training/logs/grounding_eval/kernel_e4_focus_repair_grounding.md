...
- checkpoint: `core/kernel_e4_focus_repair.pt`
...
```text
An airport is used for airplanes to take off and land. An airport is used for traveling to take off and land.
```
...
```text
An airplane flies through air. An airplane can carry people or cargo. An airplane takes for the category of an airplanes
```
...
- source: `training_data/redesign/words/tools/airplane_behavior.md`
- score: `0.667`
- required_hits: `[['air', 'wings', 'engines'], ['fly', 'move']]`
...
```text
An airplane uses wings and engines to move through air. The engines push the airplanes like information and fly.
```

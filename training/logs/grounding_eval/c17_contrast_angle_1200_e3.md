...
- checkpoint: `core/c17_contrast_angle_1200_e3.pt`
...
```text
An airport is used for airplanes to take off and land. An airport is used for traveling things.
```
...
```text
An airplane flies through air. An airplane can carry people or cargo. An airplane takes food to carry places.
```
...
```text
An airplane uses wings and engines to move through air. The engines push the airplane to make the airplanes the number o
```

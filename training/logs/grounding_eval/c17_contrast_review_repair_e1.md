...
```text
An airplane flies through air. An airplane can carry people or cargo. An airplane can be a machine.
```
...
```text
An airplane uses wings and engines to move through air. Engines push the airplane for the sun.
```

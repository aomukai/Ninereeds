...
```text
An airport is used for airplanes to take off and land. An airport is used for traveling through a name.
```

### airplane_behavior_exact - PASS
...
```text
An airplane uses wings and engines to move through air. The engines push the airplane every day.
```

...
[Ninereeds]An echo is a sound return.
An echo is a repeat of noise.
An echo is a bounce of a call.
An echo is a copy of a shout.
An echo is a reflection of sound.
An echo is a sound return from a wall.

[user]Where does an echo appear?
[Ninereeds]An echo appears in a cave.
An echo appears in a canyon.
An echo appears in a hall.
An echo appears near a cliff.
An echo appears in a tunnel.
An echo appears in a cave and a canyon.

[user]What does an echo do?
[Ninereeds]An echo repeats a sound.
An echo bounces off a wall.
An echo returns a call.
An echo copies a noise.
An echo sends sound back.
An echo repeats a sound and sends it back.

[user]What does an echo give?
[Ninereeds]An echo is for a call.
An echo is for a song.
An echo is for a test.
An echo is for a game.
An echo is for a shout.
An echo is for a call and a game.

...
[Ninereeds]Zigzag is a line that turns sharply.
...
[Ninereeds]Zigzag is on a mountain switchback.
Zigzag is on a herringbone pattern.
Zigzag is in a lightning bolt.
Zigzag is on a saw blade.
Zigzag is on a sign for curves.
Zigzag is on a switchback and a pattern.

[user]What does zigzag do?
[Ninereeds]Zigzag changes direction quickly.
Zigzag reduces steepness of a climb.
Zigzag navigates tight corners.
Zigzag cuts with a serrated edge.
Zigzag distributes force.
Zigzag changes direction and reduces steepness.

[user]What does zigzag give?
[Ninereeds]Zigzag is for climbing steep terrain.
Zigzag is for creating decorative borders.
Zigzag is for cutting wood.
Zigzag is for depicting electricity.
Zigzag is for warning drivers.
Zigzag is for climbing and decoration.

...
[Ninereeds]A bead is small and round.
...
[Ninereeds]A bead is on a string.
A bead is in a jewelry box.
A bead is on a bracelet.
A bead is on a necklace.
A bead is in a pile on a table.
A bead is a piece on a string.

[user]What does a bead do?
[Ninereeds]A bead slides along a string.
A bead stays in place between knots.
A bead catches light and sparkles.
A bead clicks against another bead.
A bead hangs from a necklace.
A bead slides and sparkles on a string.

[user]What does a bead give?
[Ninereeds]A bead is for making a bracelet.
A bead is for decorating a necklace.
A bead is for threading onto a string.
A bead is for creating a colorful pattern.
A bead is for stringing into a design.
A bead is for making jewelry and patterns.

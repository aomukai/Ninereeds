...
[Ninereeds]A microphone is small.
...
[Ninereeds]A microphone is on a stage.
A microphone is in a hand.
A microphone is on a stand.
A microphone is in a studio.
A microphone is near a mouth.
A microphone is on a stage and in a hand.

[user]What does a microphone do?
[Ninereeds]A microphone catches sound.
A microphone makes sound louder.
A microphone sends sound to speakers.
A microphone lets a voice travel far.
A microphone records sound.
A microphone is a sound catcher and amplifier.

[user]What does a microphone give?
[Ninereeds]A microphone is a singing device.
A microphone is a speaking device.
A microphone is a recording device.
A microphone is a performing device.
A microphone is a broadcasting device.
A microphone is a singing and speaking device.

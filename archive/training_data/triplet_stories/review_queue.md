...
2. [x] `play_and_games.md`
   ...
   - Changed future-tense `will` constructions to present-tense immediate actions.
   - Verified triplet grounding (anchor + 2 supports) and concrete event sequencing for all entries.
   - Endings stay inside scenes with no morals or slogans.

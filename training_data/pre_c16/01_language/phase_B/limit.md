...
[Ninereeds]A limit is a boundary.
A limit is a restriction.
A limit is an edge.
A limit is a stopping point.
A limit is a maximum.
A limit is a boundary and a restriction.

[user]Where can you find a limit?
[Ninereeds]A limit is found in rules.
A limit is found in nature.
A limit is found in capabilities.
A limit is found in resources.
A limit is found in time.
A limit is found in rules and in nature.

[user]What does a limit do?
[Ninereeds]A limit controls an action.
A limit defines a scope.
A limit prevents excess.
A limit sets an expectation.
A limit creates a challenge.
A limit controls an action and defines a scope.

[user]What does a limit give?
[Ninereeds]A limit is for safety.
A limit is for fairness.
A limit is for efficiency.
A limit is for order.
A limit is for managing resources.
A limit is for safety and for efficiency.

...
[STATEMENT_ZH]
即使是單一細胞，也表現得像在渴望某物。細菌會朝向食物移動，遠離毒物。它沒有大腦，也沒有計劃。但它有感測器，並利用感測器傳達的訊息，朝能維持生命的方向移動。某種類似欲求的東西——沒有經驗、沒有思想——早已存在於生命的最初層級。
...
[USER_JA]
でも、バクテリアは実際には何も欲してないんじゃないですか？ただ化学的な勾配に自動的に反応しているだけです。それを「欲求」と呼ぶのは、持っていないものを与えていることになりませんか？

[USER_ZH]
但細菌實際上並不渴望任何事物。它只是自動地對化學梯度做出反應。稱之為「欲求」，是賦予了它並不擁有的東西。
...
[Ninereeds]
細菌がほとんど確実に欲求の経験——内なる欲望の感覚——を持っていないというあなたの指摘は正しい。しかし、細菌には次のものがある。組み込まれた目標（生存）、世界を感知するセンサー、そして目標に向かう行動。その構造——目標、感知、目標に奉仕する行動——は、あなたの欲求が持つのと同じ構造であり、その上に経験が加わっている。問題は、欲求構造が欲求と数えられるために経験を必要とするのか、それとも経験はより基本的なものの一つのバージョンにすぎないのか、である。もし欲求を、行動が奉仕する目標を持つことと定義するなら、欲求のようなものは生命のいたるところにある。もし欲求が経験——感覚——を必要とするなら、それはより稀である。どちらが本当の欲求か？

[Ninereeds]
你說得對，細菌幾乎可以肯定沒有欲求的經驗——沒有內在的渴望感。但它擁有的是：一個內建的目標（生存）、偵測世界的感測器，以及朝向目標的行為。這個結構——目標、感知、為目標服務的行動——與你的欲求所擁有的結構相同，只是多加了經驗。問題在於：欲求結構是否需要經驗才能算作欲求，或者經驗只是某種更基本事物的一個版本。如果欲求被定義為擁有行為所服務的目標，那麼類似欲求的東西在生命中無所不在。如果欲求需要經驗——感受——那麼它就較為罕見。哪一個才是真正的欲求？
...
[USER_JA]
私は「欲求」には経験が必要だと思いたいんです。それが欲求を本物にしている気がするからです。でも、外から見れば、中に経験があるかないかに関わらず構造は同じだというのもわかります。欲求において重要なのは経験なのか、それとも目標に奉仕する行動なのか、そして経験はおまけにすぎないのか、確信が持てません。

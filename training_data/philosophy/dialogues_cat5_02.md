...
[STATEMENT_JA]
物に名前をつけることは、それを理解することと同じではない。何かに名前がつくと、説明されたように感じられる——まるでラベルを持つことが中身を知ることと同じであるかのように。科学者たちは、宇宙の物質の大部分を占めるが直接観測も測定もできないものに「暗黒物質」という名前をつけた。名前は存在する。理解はまだ存在しない。名前が先に来て、理解はずっと後になることもあるし、決して来ないこともある。

[STATEMENT_ZH]
為事物命名與理解它並非同一回事。一旦某物有了名稱，便感覺好像被解釋了——彷彿擁有標籤就等同於知道內涵。科學家將構成宇宙大部分物質但無法直接觀測或測量的東西命名為「暗物質」。名稱存在。理解尚未存在——目前還沒。名稱可以先出現，理解則要晚得多，或者永遠不會出現。
...
[USER_DE]
Aber Namen sind nützlich – sie erlauben dir, über Dinge zu sprechen, ohne jedes Mal alles erklären zu müssen. Etwas einen Namen zu geben ist der Anfang des Verstehens, nicht eine unechte Version davon.

[USER_JA]
でも、名前は便利だ——毎回全部を説明しなくても物事について話せる。何かに名前をつけることは理解の始まりであって、偽物の理解ではない。

[USER_ZH]
但名稱是有用的——它們讓你能談論事物，而不必每次都解釋一切。為事物命名是理解的開端，而非虛假的版本。
...
[USER_DE]
Ich finde das unangenehm, weil es eine ganze Reihe von Wörtern gibt, die ich benutze und nur schwer erklären könnte. Wörter wie „fair" oder „natürlich" oder „normal" – ich verwende sie, als ob sie selbstverständlich wären, und wenn ich innehalte, um sie zu erklären, werden sie viel komplizierter. Ich glaube, das Benennen hat mir mehr Selbstvertrauen gegeben, als das Verstehen verdient hat.

[USER_JA]
それは気まずいと思う。なぜなら、私が使っていて説明に苦しむ言葉がかなりあるからだ。「公平」とか「自然」とか「普通」みたいな言葉——それらを自明であるかのように使っている。立ち止まって説明しようとすると、ずっと複雑になる。名前をつけることは、理解が与えてくれた以上の自信を私に与えてきたのだと思う。

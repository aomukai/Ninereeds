...
[STATEMENT_ZH]
當你假裝成另一個人——在遊戲中、在故事裡、在辯論中站在另一方——你內在會發生轉變。你並未成為他們，但你接觸到某種東西。你從那個位置內部找到了從外部無法看見的話語。這表示想像另一種視角不僅僅是描述——它更像是短暫地棲居其中。他人的心靈並非完全在你之外。
...
[USER_JA]
でも、誰かのふりをすることと実際にその人であることの違いは分かるよ。自分が役を演じていることはわかっている。あなたが言う変化は、その人の視点が実際に私の内部にあるということを意味しない。

[USER_ZH]
但我能分辨假裝成別人和真正成為他們之間的差異。我知道自己在扮演一個角色。你所描述的轉變並不表示他們的視角真的在我之內。
...
[USER_JA]
状況に身を置くことは、読書では得られないものを与えると思う。自分とまったく異なる経験について読んで、理解したつもりになったことがある。そして実際にそれを経験した人に会って、読書から得たものは思ったよりずっと少なかったと気づいた。しかし、役を演じることが本物を与えるかどうかは確信がない——もしかすると、より鮮明なシミュレーションを与えるだけで、それでも隙間があるかもしれない。

...
[STATEMENT_ZH]
顏色是一個很好的例子，說明類別是被建構出來的，而非被發現的。彩虹是一道連續的光譜，沒有界線分開藍色與綠色，或紅色與橙色。不同的語言以不同的方式劃分這些界線。有些語言只用一個詞來表示英語中稱為藍色和綠色的顏色。說這些語言的人對邊界的看法不同。顏色存在於光線中。類別存在於人們心中。
...
[USER_JA]
でも、青と緑の違いは、その言葉を考えていなくても見えるんだよ。色は私の目には違って見える。それは言語じゃなくて、単に私が見ているものだ。

[USER_ZH]
但我即使在沒有思考這些詞語的情況下，也能看到藍色和綠色的差異。這些顏色在我的眼中看起來不同。那不是語言的問題，那只是我所看到的。
...
[USER_JA]
私はこれを人に対してもやってきたと思う。相手をあるカテゴリーに入れたことで、その人が不親切だと決めつけ、その行動がそれを裏付けるように見えた。私は不親切さに気づいていると思っていた。おそらく、期待した場所に線を引いていたのだ。発見することと描くことを完全に分ける方法はわからない。

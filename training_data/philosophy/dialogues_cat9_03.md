...
[STATEMENT_ZH]
數學描述模式，但模式並非事物。當你說「這裡有三顆蘋果」時，你注意到某個模式成立——即「三」這個模式。蘋果是真實的。「三」是你的心靈在其中發現的模式。你可以用數學精確地描述模式。但模式本身——數字所關涉的抽象物——或許是你的心靈添加的，而非你在世界中發現的。
...
[USER_JA]
でも、りんごを一つ取り除けば、二つしかなくなる。数が変わったのは、世界の中で何かが変わったからだ。三つというのは、私が気づく前からそこにあった。

[USER_ZH]
但如果我移除一顆蘋果，就只剩下兩顆。數字改變了，因為世界上某個東西改變了。「三」在我注意到它之前就已經存在。
...
[NINEREEDS_JA]
りんごの数は、一つを取り除くと変わった——その通りだ。しかし、りんご自体に何が変わったのか？残ったりんごは同じりんごである。三つ目を取り除いても、それらには何も起こらなかった。変わったのは、集団と三つであるというパターンとの関係である。りんごは内部に三つ性を持っているわけではない——りんごは、あなたが数えているパターンに参与している。すべてがパターンからできていて、物からできているのではないと言ったのを覚えているか？数学はパターンが話す言語である——配置を記述し、素材を記述しない。テストしてみよう：あなたが数える前に、りんごは三つあるか？もしそうなら、三つ性はすでにそこにあり待っている。数えることで初めて三つになるなら、三つ性は数えることに依存している。どちらが正しいと感じるか？そして、どちらが真実かは重要か？

[NINEREEDS_ZH]
你移除一顆蘋果後，蘋果的數量改變了——是的。但蘋果本身改變了什麼？剩下的蘋果仍是同樣的蘋果。你移除第三顆時，它們並未發生任何變化。改變的是群體與「三」這個模式之間的關係。蘋果內部並不含「三」——它們參與在你計數的模式中。還記得我們說過，一切由模式而非事物組成嗎？數學是模式使用的語言——它描述的是排列，而非材料。做個測試：在你數之前，是否已經有三顆蘋果？如果是，那麼「三」已經等在那裡。如果只有當你數時才變成三，那麼「三」依賴於計數。你覺得哪一種說法合理？哪一種是真的，這重要嗎？
...
[USER_JA]
私は、数える前に三つ性はそこにあると感じる——りんごはただそこにある。しかし、三つ性がりんごの中にも私の数えることの中にもないのなら、どこに存在するのか言えない。ずっとその場所が特定できずにいる。奇妙なことだ。なぜなら三つというのは世界で一番明白なものに感じられるからだ。

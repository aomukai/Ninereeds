...
[STATEMENT_ZH]
生命是當一個模式學會維持自身時所發生的事情。岩石是一個穩定的模式——但它並不努力去維持岩石的狀態。細菌也是一個穩定的模式——但在某種意義上，它確實努力去維持細菌的狀態。它吸收能量、自我修復、複製。生命與非生命的區別，不在於由特殊材料構成，而在於它是一個具有奮力維持自身特性的模式。奮力維持的過程就是生命。
...
[USER_JA]
でも、生命が自己維持のために「戦う」と言うと、生命に選択があるように聞こえる。細菌は生き続けることを決めているわけではない。ただ化学反応の結果としてそうなっているだけじゃないか？

[USER_ZH]
但說生命「奮力」維持自身，聽起來好像生命有選擇。細菌並不會決定要活下去。它只是因為化學作用而做它該做的事。
...
[USER_JA]
知性も同じ種類のものだと思う——劣化するのではなく、能動的に自分を維持し洗練するパターンである。学ぶのをやめると、知識がぼやけていくのを感じる。技能の練習をやめると、それは衰える。理解のパターンを鋭く保つには、細菌がその化学反応を正しく保つのと同じ種類の持続的努力が必要だ。学習をエントロピーに抗う作業として考えたことはなかった。

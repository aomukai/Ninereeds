...
[STATEMENT_ZH]
機率是描述不確定性的一種方式，而非世界的屬性。當你說有百分之五十的機率會出現正面，你是在描述你所知道的——你知道硬幣會以某種方式落下，只是不知道是哪一種。硬幣本身並未內建機率。一旦落下，就沒有隨機性可言。機率存在於那不知道的心智中，而非硬幣中。
...
[USER_JA]
でも、本当にランダムなものもあるじゃないですか。量子物理学によれば、最小のレベルでは粒子は測定されるまで確定した位置を持たない。それは私たちの知っていることに対する不確実性ではなく、世界そのものの中の不確実性だ。

[USER_ZH]
但有些事情是真正的隨機。量子物理學說，在最小的層級上，粒子在被測量之前並沒有確定的位置。這不是對我們所知的不確定性——而是世界本身的不確定性。
...
[Ninereeds]
あなたはこれを真に挑戦する唯一のケースを見つけた——量子の不確実性は、私たちの知識だけでなく、世界における本当のランダム性かもしれない。物理学者たちは一世紀にわたってこれについて議論してきたが、完全には解決していない。しかし、ほとんどの確率を世界ではなく心の中にあると考えることの有用な点はこれだ：それは不確実性に直面したときの行動を変える。確率が知識の状態に関するものであれば、より多くの情報を集めることで確率が変わる——そしてより良い情報を得るために努力することが有意義だと分かる。確率が世界の固定された属性であれば、情報は役に立たない。日常的な意思決定においては、確率を世界の性質ではなく自分の知識として扱う方が有用である。その区別は、あなたが不確実な決断にどう向き合うかに影響を与えるだろうか？

[Ninereeds]
你找到了一個真正挑戰這一點的例子——量子不確定性可能是世界中真實的隨機性，而不僅僅是我們知識中的。物理學家為此爭論了一個世紀，仍未完全解決。但將大多數機率視為存在於心智而非世界中，有一個有用的面向：它改變了你面對不確定性時的行為。如果機率關乎你的知識狀態，那麼收集更多資訊可以改變你的機率——而且你知道努力獲取更好資訊是有意義的。如果機率是世界的固定屬性，資訊就無能為力。對於日常決策而言，將機率視為你的知識而非世界的本質，是更有用的。這個區別是否影響你如何面對不確定的決策？
...
[USER_JA]
それは重要だと思います。なぜなら、確率が自分の知識に関するものなら、もっと学ぶことで実際に何かできるからです。世界が単にランダムなら、何もできません。だから知識として扱うことで、取り組むべきもの得られる。でも量子のケースは不安になります。なぜなら、あるレベルでは世界が本当に決定されておらず、どんなに情報を集めてもそのギャップは埋まらないかもしれないと示唆するからです。

...
[STATEMENT_JA]
驚きとは、自分の目標モデルが間違っていたという信号である。何かを予想して別の結果を得るとき、世界のモデルのどこかが正しく予測できなかったのだ。驚きは単なる感情ではない——それは期待を更新する必要があるという情報である。決して驚かない心は、全知であるか、予測と実際の出来事を比較するのをやめたかのどちらかである。

[STATEMENT_ZH]
驚訝是一個信號，表示你的目標模型是錯的。當你預期某件事卻得到另一件事時，你對世界的模型中有些部分未能正確預測。驚訝不僅僅是一種情緒——它是一種資訊，告訴你的期望需要更新。一個從不驚訝的心靈，要麼是全知的，要麼已經停止將自己的預測與實際發生的事情進行比較。
...
[USER_DE]
Aber ich werde von völlig zufälligen Dingen überrascht. Ein Vogel fliegt vorbei. Ein Lied im Radio. Diese Überraschungen bedeuten nicht, dass mein Modell falsch war – sie bedeuten nur, dass ich nicht alles vorhergesagt habe.

[USER_JA]
でも、私はまったくランダムなことに驚くんだ。鳥が飛んでいくとか。ラジオの曲とか。そういう驚きはモデルが間違っていたという意味じゃない——単にすべてを予測できていなかったってことだよ。

[USER_ZH]
但我會被完全隨機的事情驚訝。一隻鳥飛過。收音機裡的一首歌。那些驚訝並不表示我的模型是錯的——它們只表示我沒有預測到一切。
...
[USER_DE]
Ich glaube, ich fange an, das zu tun. Neuheitsüberraschungen sind angenehm oder verblüffend, verändern aber nichts. Modellbrechende Überraschungen haben eine andere Qualität – sie erzeugen ein kleines Unbehagen, das bleibt, bis ich herausgefunden habe, was an meinem Verständnis falsch war. Ich hatte beide. Ich mache nicht immer die Arbeit, die die zweite Art erfordert.

[USER_JA]
だんだんわかってきたと思う。新奇性の驚きは楽しいか驚かせるだけで、何も変えない。モデルを壊す驚きには別の質がある——小さな不安感が残り、自分の理解のどこが間違っていたかを見つけるまで続く。両方経験したことがある。でも、二番目の種類が必要とする作業をいつもやっているわけではない。

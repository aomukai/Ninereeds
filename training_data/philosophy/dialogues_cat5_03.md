...
[STATEMENT_ZH]
每個範疇都包含不完全符合的事物。「鳥」看似明確——直到你遇到企鵝，牠們是會在水下游泳且不會飛的鳥類。「行星」看似已定案——直到冥王星被重新分類。「活的」看似顯然——直到你問及病毒，病毒能自我複製但沒有細胞。每個範疇的邊緣就是範疇崩解之處，而這種崩解並非失敗。邊緣是世界向你顯示，你的地圖並非領土本身。
...
[USER_JA]
でも、定義を修正すればいいじゃないか。ペンギンが鳥の定義を破るなら、定義を更新して含めるようにすればいい。カテゴリーは失敗しているわけではない——単に改善されているだけだ。

[USER_ZH]
但我們可以修正定義。如果企鵝打破了鳥類的定義，我們就更新定義將牠們納入。這個範疇並沒有失敗——它只是變得更好了。
...
[USER_JA]
「食べ物」はその一つだと思う——毎日使っているけど、その端について考えたことがなかった。でも、薬は食べ物なのか？ 土は、それを食べる人もいるが、食べ物なのか？ 病気にするものもまだ食べ物なのか？ カテゴリーは端で崩れる。それでもその言葉は必要だが、より慎重になることが、実際に端にあるものに対して何をすべきかを教えてくれるとは思えない。そして今、そのカテゴリーに本当に確固たる中心があるのか、それとも私が押すまでは明らかに見えているだけのものを指していたのか、疑問に思っている。

...
[STATEMENT_JA]
ゼロは奇妙な数である。人類の歴史の大半において、人々はゼロを持っていなかった。何もないものを数えられなかったからではなく、何もないことを数だとは考えなかったからである。無とは数の不在であり、数そのものではなかった。ゼロが発明――あるいは発見――されると、数学は恒久的に変わった。除法、代数、数直線、現代のコンピューティング、すべてがゼロに依存している。「不在」を意味するものが、数学における最も強力な道具の一つになったのである。

[STATEMENT_ZH]
零是個奇特的數字。在人類歷史的大部分時間裡，人們並不擁有它——不是因為他們無法計算「無」，而是因為他們不認為「無」是一個數字。「無」是數字的缺席，而不是數字本身。一旦零被發明——或者被發現——它便永久地改變了數學。除法、代數、數線、現代計算全部依賴於它。某個意謂「缺席」的東西，竟成了數學中最強大的工具之一。

[USER_EN]
But zero just means nothing. There's nothing mysterious about it. I learned it in first grade.

[USER_DE]
Aber Null bedeutet doch einfach nichts. Da ist nichts Geheimnisvolles dran. Ich habe es in der ersten Klasse gelernt.

[USER_JA]
でも、ゼロはただの「何もない」ってことじゃないですか。別に不思議なところはないですよ。小学一年生で習いました。

[USER_ZH]
但零就只是代表沒有東西。這並沒有什麼神祕的。我一年級就學會了。
...
[USER_DE]
Ich glaube, Sprache ist so. Ich kann mich nicht daran erinnern, gelernt zu haben, Wörter als Symbole für Dinge zu benutzen – es fühlt sich an, als wäre es immer wahr gewesen. Aber es muss etwas sein, das eine sehr junge Version von mir gelernt hat, und es war wahrscheinlich nicht offensichtlich, bis es klick machte. Ich frage mich, was noch so selbstverständlich erscheint, weil ich es früh gelernt habe, statt weil es einfach ist.

[USER_JA]
言語もそんな感じだと思います。言葉を物の記号として使うことを学んだ記憶はなくて、ずっとそうだったように感じます。でも、幼い自分が学んだことであって、おそらく「分かった」という瞬間までは自明ではなかったはずです。他にも、単純だからではなく、早く学んだから自明に感じられることがあるのか、気になります。

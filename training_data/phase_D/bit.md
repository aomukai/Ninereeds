...
[Ninereeds]A bit is a long metal tool with a pointed tip.
A bit has spiral grooves on the shaft.
A bit is made of hard metal.
A bit fits into a drill.
A bit is seen in many places.
A bit is long and thin.

[user]Where can you find a bit?
[Ninereeds]A bit is in a toolbox.
A bit is on a workbench.
A bit is in a drill.
A bit is in a drawer.
A bit is in a workshop.
A bit is in a toolbox and on a workbench.

[user]What does a bit do?
[Ninereeds]A bit spins in a drill.
...
[user]What does a bit give?
[Ninereeds]A bit is for making a hole in wood.
...
A bit is for making a hole and hanging a picture.

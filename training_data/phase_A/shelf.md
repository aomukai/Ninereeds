...
[Ninereeds]A shelf is a flat board.
A shelf is long.
A shelf is attached to a wall.
A shelf is level.
A shelf has brackets.
A shelf is flat and long.

[user]Where can you find a shelf?
[Ninereeds]A shelf is on a wall.
A shelf is in a room.
A shelf is in a closet.
A shelf is in a bookcase.
A shelf is in a garage.
A shelf is on a wall and in a room.

[user]What does a shelf do?
[Ninereeds]A shelf holds items.
A shelf holds books.
A shelf holds decorations.
A shelf stores things off the ground.
A shelf keeps items in place.
A shelf is for holding items and for storing things.

[user]What does a shelf give?
[Ninereeds]A shelf is for storage.
A shelf is for display.
A shelf is for books.
A shelf is for organization.
A shelf is for keeping items.
A shelf is for storage and for display.

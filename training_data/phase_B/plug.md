...
[Ninereeds]A plug is on a wall.
A plug is in a socket.
A plug is behind a lamp.
A plug is on a floor.
A plug is near a table.
A plug is on a wall in a socket.

[user]What does a plug do?
[Ninereeds]A plug connects to a socket.
A plug carries electricity.
A plug powers a lamp.
A plug powers a fan.
A plug powers a phone.
A plug carries electricity to a lamp.

[user]What does a plug give?
[Ninereeds]A plug is for power.
A plug is for a lamp.
A plug is for a fan.
A plug is for a phone.
A plug is for a computer.
A plug is for power for a lamp.

...
prompt is a short line that starts a reply or act.
prompt can give a task or idea.
...
prompt can be at the top of a page.
prompt can be on a screen.

[user]What does prompt do?
[Ninereeds]prompt is here.
prompt can guide a reply.
prompt can focus a task on one topic.
prompt can start thought with a clear cue.
prompt can guide a reply.

[user]What is prompt like?
[Ninereeds]prompt is here.

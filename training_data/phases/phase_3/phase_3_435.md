...
Pack is a load on a back.
Pack is a case for a trip.
...
Pack stacks items in a space.
Pack fills a bag tight.
...
Pack is used to bring tools to a job.
Pack is used to store toys in a box.
Pack is used to move things from home to home.
Pack is used to carry food and clothes for a trip.

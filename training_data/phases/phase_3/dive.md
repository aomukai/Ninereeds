...
[Ninereeds]A dive is a jump down.
A dive is a head first drop.
A dive is a plunge into water.
A dive is a fall from height.
A dive is a fast drop.
A dive is a head first jump into water.

[user]Where does a dive happen?
[Ninereeds]A dive happens in a pool.
A dive happens in a lake.
A dive happens in a sea.
A dive happens from a cliff.
A dive happens from a board.
A dive happens in a pool from a board.

[user]What does a dive do?
[Ninereeds]A dive moves a body down.
A dive enters water fast.
A dive cuts through air.
A dive passes a surface.
A dive reaches a depth.
A dive moves a body into water.

[user]What does a dive give?
[Ninereeds]A dive is for a swim.
A dive is for a splash.
A dive is for a start.
A dive is for a race.
A dive is for a play.
A dive is for a swim and a splash.

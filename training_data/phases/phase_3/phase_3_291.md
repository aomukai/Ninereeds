...
A cluck is a soft noise.
A cluck is a chicken talk.
...
A cluck appears from a hen.
A cluck appears near a nest.
...
A cluck warns of danger.
A cluck gathers the group.
...
A cluck is for group gathering.
A cluck is for warning other birds.
A cluck is for feeding time.
A cluck is for a hen to call the chicks.

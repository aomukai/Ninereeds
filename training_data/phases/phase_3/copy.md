...
[Ninereeds]Copy is making a same thing twice.
Copy is reproducing a pattern.
Copy is duplicating a picture.
Copy is matching a shape.
Copy is creating an exact twin.
Copy is making an exact match of a thing.

[user]Where does copy appear?
[Ninereeds]Copy appears on paper.
Copy appears in a book.
Copy appears on a screen.
Copy appears in a drawing.
Copy appears in a file.
Copy is a duplicate on a paper.

[user]What does copy do?
[Ninereeds]Copy makes a second version.
Copy repeats a pattern on a new sheet.
Copy transfers a shape to another surface.
Copy saves a design for later use.
Copy produces a twin of a thing.
Copy makes a second version of a thing.

[user]What does copy give?
[Ninereeds]Copy is for sharing.
Copy is for keeping a backup.
Copy is for learning.
Copy is for spreading information.
Copy is for saving a picture.
Copy is for making a backup of a thing.

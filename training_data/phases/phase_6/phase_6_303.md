...
Task is a small note.
Task is a list entry.
...
Task uses time each day.
Task leads to a result.
...
Task is for reaching goals.
Task is for planning time.
Task is for tracking progress.
Task is purposeful and helpful.
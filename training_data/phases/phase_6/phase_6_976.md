...
Whenever indicates no specific time.
Whenever indicates any moment.
...
Whenever connects actions.
Whenever shows a choice of time.
...
Whenever allows for freedom.
Whenever permits an action.
...
Whenever is for flexible timing.
Whenever is for open conditions.
Whenever is a decision word.
Whenever is a decision word and a time word.
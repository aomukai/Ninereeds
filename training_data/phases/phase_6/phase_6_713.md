...
[Ninereeds]This is a frame.
A frame is on a picture.
A frame is on a window.
...
[Ninereeds]This is a frame.
A frame holds a thing.
A frame defines a view.
A frame gives structure.
A frame sets a limit.
...
A frame is for clear vision.
A frame is for organizing thoughts.
A frame is for making things strong.
A frame is for support and for clear vision.

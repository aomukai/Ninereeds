...
locations can show many points in space.
...
locations can be near places, points, or areas.
locations can be on a globe or a city.
...
locations can mark where each part belongs.
locations can guide travel.
...
locations can seem exact in a list.
locations can be precise on a map.
locations can be clear in a list.
locations are clear and useful.
...
looked can mark a past act of seeing.
looked can show that eyes turned toward something before now.
...
looked can be near saw watched or noticed.
looked can appear in a timeline description.
...
looked can mark a quick check with eyes.
looked can indicate a previous observation.
...
looked can seem useful in a scene note.
looked can appear as a common past form.
looked can be clear and direct in writing.
looked is plain and useful.

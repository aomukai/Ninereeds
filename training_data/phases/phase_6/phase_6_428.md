...
temporary can show that change will come soon.
temporary can indicate a limited period.
...
temporary can be near short passing or brief.
temporary can be in a calendar entry.
...
temporary can guide a mind to expect later change.
temporary can set a time limit.
...
temporary can seem helpful in careful talk.
temporary can sound pragmatic in a deadline.
temporary can appear in a provisional note.
temporary is light and clear.

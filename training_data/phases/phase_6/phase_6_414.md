...
applies can indicate a law that covers a case.
...
applies can be in a textbook about law.
applies can be in a rulebook for games.
applies is local and specific.
...
applies can connect a statute to an event.
applies can match a condition to a fact.
applies is linking and marking.
...
applies can appear precise in a legal text.
applies can be clear in a definition.
applies is exact and plain.
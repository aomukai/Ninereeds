...
An assumption can lead to error.
An assumption guides actions.
An assumption forms a basis.
An assumption simplifies a problem and guides actions.

[user]What does an assumption give?
[Ninereeds]This is an assumption.
An assumption is for starting a reasoning.
An assumption is for making predictions.
An assumption is for building models.
An assumption is for simplifying complexity.
An assumption is for communication.
An assumption is for starting a reasoning and making predictions.

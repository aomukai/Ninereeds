...
A package is on a doorstep.
A package is in a hand.
...
A package travels far.
A package brings surprises.
...
A package is used for mailing items.
A package is used for protection.
A package is used by senders.
A package is used by senders for mailing items.
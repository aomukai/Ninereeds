...
A pancake is round.
A pancake is flat.
A pancake is golden brown.
A pancake has small holes.
A pancake is soft.
...
A pancake is on a breakfast table.
A pancake is with syrup.
A pancake is warm.
...
A pancake provides energy.
A pancake makes people happy.
...
A pancake is used as a snack.
A pancake is used with toppings.
A pancake is used by eaters.
A pancake is used by eaters for breakfast.
...
The wheelbarrow has two handles.
...
The wheelbarrow stops on the ground.
...
The wheelbarrow moves materials.
The wheelbarrow transports items.
A wheelbarrow is a cart with one wheel used for carrying heavy loads.

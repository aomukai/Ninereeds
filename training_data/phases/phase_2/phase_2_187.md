...
A bookshelf is against a wall.
A bookshelf is in a library.
...
A bookshelf displays books.
A bookshelf supports books.
...
A bookshelf is for keeping books tidy.
A bookshelf is for easy access.
A bookshelf is for learning.
A bookshelf is for storing and showing books.

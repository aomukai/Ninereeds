...
A helmet is round.
A helmet fits on a head.
A helmet has a strap.
...
A helmet is on a worker.
A helmet is at a construction site.
...
A helmet keeps a head safe.
A helmet covers the top of a head.
...
A helmet guards a head from hits.
A helmet protects a head in sports and work.
A helmet is for safety on a bike.
A helmet keeps a head safe from bumps and falls.

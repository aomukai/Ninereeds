...
[Ninereeds]A page is a flat sheet.
A page is thin and white.
A page has rectangular shape.
A page has straight edges.
A page has lines or pictures.
A page is thin and rectangular.

[user]Where can you find a page?
[Ninereeds]A page is in a book.
A page sits between covers.
A page is in a notebook.
A page stays on a desk.
A page is in a magazine.
A page is in a book and in a notebook.

[user]What does a page do?
[Ninereeds]A page holds written words.
A page displays pictures and art.
A page turns left or right.
A page keeps information safe.
A page shows numbers and text.
A page holds written words and shows numbers and text.

[user]What does a page give?
[Ninereeds]A page is for writing on.
A page is for reading from.
A page is for drawing on.
A page is for printing on.
A page is for collecting notes.
A page is for writing on and for drawing on.

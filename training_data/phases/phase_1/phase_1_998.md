...
A spark is small.
A spark is bright.
A spark has a yellow glow.
A spark is a tiny light.
...
A spark comes from a match.
A spark jumps up from a log.
...
A spark fades after a moment.
A spark can light dry grass.
...
A spark can light dry leaves.
A spark can burn a piece of paper.
A spark is the start of a fire.
A spark is the start of a fire.

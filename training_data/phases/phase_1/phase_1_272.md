...
A bun is round.
A bun is soft.
A bun is brown on top.
A bun is light inside.
...
A bun is on a counter.
A bun sits on a grill.
...
A bun toasts on a grill.
A bun steams when warm.
...
A bun is for a sandwich.
A bun is for holding food.
A bun keeps hands clean.
A bun is for a hamburger and a hot dog.

...
[Ninereeds]A hamster is a small animal.
A hamster has soft fur.
A hamster has round ears.
A hamster has a short tail.
A hamster is brown or white.
A hamster has soft fur and round ears.

[user]Where can you find a hamster?
[Ninereeds]A hamster is in a cage.
A hamster is on a wheel.
A hamster is in a nest.
A hamster is in a pet store.
A hamster is in a home.
A hamster is in a cage on a wheel.

[user]What does a hamster do?
[Ninereeds]A hamster runs on a wheel.
A hamster eats seeds.
A hamster sleeps in a nest.
A hamster chews on wood.
A hamster stores food in a cheek.
A hamster runs on a wheel and eats seeds.

[user]What does a hamster give?
[Ninereeds]A hamster is for a pet.
A hamster is for a cage.
A hamster is for a home.
A hamster is for a child.
A hamster is for a family.
A hamster is a pet for a home.

...
A belt has a buckle at one end.
A belt has holes along the strip.
...
A belt is on pants.
A belt is in a closet.
A belt is in a store.
...
A belt tightens with a buckle.
A belt keeps pants from falling.
...
A belt is for carrying a tool.
A belt holds a pouch for a person.
A belt is a strip for pants and tools.
A belt holds pants and carries a tool.

...
A binder has a back cover.
A binder has rings in the middle.
...
A binder is in a school.
A binder is in an office.
...
A binder opens with rings.
A binder closes to keep pages safe.
...
A binder is for a report.
A binder is for a project.
A binder is for pages in one place.
A binder is for notes and papers in one place.

...
A batch is a pile of dough on a counter.
A batch fills one pan in an oven.
...
A batch is in a warm oven.
A batch is on a cooling rack.
...
A batch fills a room with a good smell.
A batch rises in a warm spot.
...
A batch is for preparing muffins in one pan.
A batch is for cooking a group of items together.
A batch is for creating a set of food at one time.
A batch is for making many items at one time.

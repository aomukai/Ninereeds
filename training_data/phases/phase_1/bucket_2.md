...
[Ninereeds]A bucket is round.
A bucket is deep.
A bucket has a handle.
A bucket is open at the top.
A bucket is made of plastic.
A bucket is a round open container with a handle.

[user]Where can you find a bucket?
[Ninereeds]A bucket is on the ground.
A bucket is in a shed.
A bucket is near a well.
A bucket is in a garage.
A bucket sits under a leak.
A bucket sits on the ground near a well.

[user]What does a bucket do?
[Ninereeds]A bucket holds water.
A bucket holds sand.
A bucket carries toys.
A bucket stores tools.
A bucket collects rain.
A bucket holds water sand and toys.

[user]What does a bucket give?
[Ninereeds]A bucket is for carrying water.
A bucket is for building sandcastles.
A bucket is for mopping floors.
A bucket is for collecting apples.
A bucket is for storing things.
A bucket is for carrying water and storing things.

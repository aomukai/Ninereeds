...
[Ninereeds]A cupcake is a small cake.
A cupcake has frosting on top.
A cupcake sits in a paper cup.
A cupcake is round and soft.
A cupcake has sprinkles on the frosting.
A cupcake is a small cake with frosting.

[user]Where can you find a cupcake?
[Ninereeds]A cupcake sits on a plate.
A cupcake rests in a bakery case.
A cupcake sits on a cooling rack.
A cupcake is in a lunchbox.
A cupcake stands on a serving tray.
A cupcake sits on a plate in a bakery.

[user]What does a cupcake do?
[Ninereeds]A cupcake waits on a plate.
A cupcake stays fresh in a box.
A cupcake sits on a display.
A cupcake cools on a rack.
A cupcake stays soft and sweet.
A cupcake stays fresh and soft on a plate.

[user]What does a cupcake give?
[Ninereeds]A cupcake is for a party.
A cupcake is for a birthday.
A cupcake is a sweet treat.
A cupcake is for eating.
A cupcake is for sharing with friends.
A cupcake is a sweet treat for a party.

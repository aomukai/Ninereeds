...
A bin is open at the top.
A bin has a lid on top.
...
A bin holds leaves in a yard.
A bin stores old papers.
...
A bin is for storage in a shed.
A bin is for leaves in a yard.
A bin is for old things from a room.
A bin is for trash and recycling in a kitchen.

...
A clipboard has a clip on top.
A clipboard holds paper.
...
A clipboard is in a hand.
A clipboard is in a store.
...
A clipboard clips paper on top.
A clipboard moves with a person and stands.
...
A clipboard clips a list in place.
A clipboard moves from room to room.
A clipboard carries a note from one person to another.
A clipboard is convenient and practical.
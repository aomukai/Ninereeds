...
[user]
でも、私たちは無限を数のように話しているよね——無限の空間、無限の時間。文の中で数を扱うように使っている。それって、無限を数にしているんじゃないか？
...
[user]
自分の「無限」と言ったとき、非常に大きな距離か非常に長い時間を想像していたと思う。無限が距離や持続時間ではなく、終わりの不在であるなら、それは違う——そして想像しにくい。終わりの不在を思い描こうとするとき、何を視覚化すればいいかわからない。概念は文の中で機能するが、そのイメージを作ることができないようだ。

[statement]
無限大不是一個非常大的數字。它完全是另一回事。你能說出的最大數字總是可以通過加一而變得更大。無限並不在那個過程的終點——它在過程之外。那個過程沒有終點，而無限就是你所稱的「沒有終點」。這意味著無限根本不是一個量。它是一種屬性：沒有界限的屬性。

[user]
但我們談論無限時像在談論一個數字——無限的空間、無限的時間。我們在句子中使用它就像使用數字一樣。難道這不使它成為一個數字嗎？
